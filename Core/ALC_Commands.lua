...
function ALC.register_slash_commands()
	...
	SLASH_COMMANDS["/alcsinglepass"] = function()
		ALC.settings.is_single_pass_cleanup = not ALC.settings.is_single_pass_cleanup
		d("|c00FFFF[ALC]|r " .. ALC.L("CHAT_SINGLE_PASS_TOGGLE", ALC.settings.is_single_pass_cleanup and ALC.L("WORD_ON") or ALC.L("WORD_OFF")))
	end
