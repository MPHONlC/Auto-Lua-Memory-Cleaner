...
function ALC.build_lam2_menu()
	...
	table.insert(cleanup_controls, {
		type = "checkbox",
		name = function() return ALC.L("CHK_SINGLE_PASS_CLEANUP") end,
		getFunc = function() return ALC.settings.is_single_pass_cleanup end,
		setFunc = function(v) ALC.settings.is_single_pass_cleanup = v end
	})
