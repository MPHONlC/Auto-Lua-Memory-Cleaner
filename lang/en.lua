...
ALC.Lang.en = {
	...
	CHAT_POOL_RELOAD_STUCK = "The pool did not shrink after the reload (%.1f MB). ESO keeps this memory until the game is restarted, so ALC will not reload for the pool again until then.",
	...
	CHAT_POOL_CONFIRM_UNAVAILABLE = "Auto Pool Cleanup After Travel is off, so its confirmation setting has no effect.",
	CHAT_SINGLE_PASS_TOGGLE = "Single Pass Cleanup: %s",
	...
	CHK_SINGLE_PASS_CLEANUP = "Single Pass Cleanup",
	...
	CMD_ALCSINGLEPASS = "Toggle Single Pass Cleanup",
